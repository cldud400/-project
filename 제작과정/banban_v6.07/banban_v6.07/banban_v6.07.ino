...
void setup()
{
  ...
  //rtc.setDOW(WEDNESDAY); //요일설정
  //rtc.setTime(23,53,10); //시간설정 시,분,초
  //rtc.setDate(03,06,2020); //날짜설정 일 월 년
